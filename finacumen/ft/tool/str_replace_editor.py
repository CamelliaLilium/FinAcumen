...
from finacumen.ft.tool import BaseTool
from finacumen.ft.tool.base import CLIResult, ToolResult
from finacumen.ft.tool.file_operators import (
    FileOperator,
    LocalFileOperator,
    PathLike,
    SandboxFileOperator,
...
* Use this tool ONLY when there is explicit, verifiable file evidence (absolute path and real file context)
* If user-provided context already contains enough information to solve the task, do not call this tool
